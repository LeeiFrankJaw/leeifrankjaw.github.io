...
\makeatletter
\newtheoremstyle{plain}{10pt}{10pt}{\itshape}{}{\bfseries}{}{.5em}{%
  \thmname{#1}\thmnumber{\@ifnotempty{#1}{ }\@upn{#2}}%
  \thmnote{ {\the\thm@notefont（#3）}}%
  % \@ifnotempty{#3}{\thm@headsep=.75ex}
}
\newtheoremstyle{definition}{10pt}{10pt}{}{}{\bfseries}{}{.5em}{%
  \thmname{#1}\thmnumber{\@ifnotempty{#1}{ }\@upn{#2}}%
  \thmnote{ {\the\thm@notefont（#3）}}%
  % \@ifnotempty{#3}{\thm@headsep=.75ex}
}
\newtheoremstyle{remark}{3pt}{3pt}{}{}{\bfseries}{\ignorespaces}{\z@}{%
  \@ifempty{#3}{\thmname{#1}}{\thmname{#3}}\hskip.5em\ignorespaces}
\makeatother
...
\setlist{itemsep=7pt plus 2pt minus 1pt}
