...
\section[固有名詞]{\ruby[rubysmash=true]{固|有|名|詞}{こ|ゆう|めい|し}}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{*{9}{C{X}|}C{X}}
    ...
    & \ruby{大|阪}{おお|さか}
    & \ruby{日|本|人}{に|ほん|じん}
    & \ruby{中|国|人}{ちゅう|ごく|じん}
  \end{tabularx}
\end{table}

\section[自己紹介]{\ruby{自|己}{じ|こ}\ruby[pre=1,post=1]{紹介}{しょうかい}}
...
\ruby{貴方}{あなた}は李さんですか。はい、私は李さんです。
\endgroup
