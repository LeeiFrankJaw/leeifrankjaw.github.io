...
\NewDocumentCommand{\txt}{O{\quad}O{\quad}m}{#1\text{#3}#2}
\newcommand*{\ifs}{\txt[][\ ]{if}}
...
\DeclarePairedDelimiterXPP{\E}[1]{\Eop}{%
  \lbrack}{\rbrack}{}{\renewcommand{\mid}{\SetSymbol[\delimsize]}#1}
\DeclarePairedDelimiterXPP{\Var}[1]{\qopname\relax o{Var}}{%
  \lparen}{\rparen}{}{\renewcommand{\mid}{\SetSymbol[\delimsize]}#1}
\DeclarePairedDelimiterXPP{\Cov}[1]{\qopname\relax o{Cov}}{%
  \lparen}{\rparen}{}{\renewcommand{\mid}{\SetSymbol[\delimsize]}#1}
\let\exp\relax
\DeclarePairedDelimiterXPP{\exp}[1]{\qopname\relax o{exp}}{%
  \lbrace}{\rbrace}{}{#1}
\let\Pr\relax
\DeclarePairedDelimiterXPP{\Pr}[1]{\qopname\relax o{\mathbb{P}}}{%
  \lparen}{\rparen}{}{\renewcommand{\mid}{\SetSymbol[\delimsize]}#1}
\DeclarePairedDelimiterXPP{\pnorm}[1]{\Fn{\Phi}}{\lparen}{\rparen}{}{#1}
\DeclarePairedDelimiterXPP{\dnorm}[1]{\fn{\varphi}}{\lparen}{\rparen}{}{#1}
\DeclarePairedDelimiterXPP{\med}[1]{\medop}{%
  \lparen}{\rparen}{}{#1}
\DeclarePairedDelimiterXPP{\I}[1]{\qopname\relax o{\mathbb{1}}}{%
  \lparen}{\rparen}{}{#1}
...
\newcommand*{\reason}{\text}
\newcommand*{\vect}{\symbf}
\newcommand*{\mat}{\symbf}
\newcommand*{\Hess}{\symbf{H}}
\newcommand*{\trans}{^{\symsf{T}}}
\newcommand*{\grad}{\nabla}